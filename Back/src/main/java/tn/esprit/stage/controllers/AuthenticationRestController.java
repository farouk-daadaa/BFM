...
import tn.esprit.stage.Configurations.JwtService;
import tn.esprit.stage.Configurations.SecurityPrincipale;
import tn.esprit.stage.entities.AuthenticateResponse;
import tn.esprit.stage.entities.RegesterRequest;
import tn.esprit.stage.entities.VerifyVerificationCodeRequest;
import tn.esprit.stage.entities.PasswordResetUtil;
import tn.esprit.stage.entities.EntityResponse;
import tn.esprit.stage.entities.AuthenticationRequest;
import  tn.esprit.stage.entities.ModifyUserProfileRequest;
import tn.esprit.stage.entities.User;
import tn.esprit.stage.services.AuthenticationService;
import tn.esprit.stage.services.UserServiceImpl;
